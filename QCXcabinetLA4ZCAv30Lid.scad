...
part=2;             // 1=main cabinet, 2=lid, 4 knob preview, 5=all
...
// Paddle attachment
use <D:\TSk\Hobby\QCX_transceiver\QCXcabinetPaddleAttach.scad> // defines QCXpaddleHeight, QCXpaddleAttachment() and QCXpaddleStopper()
